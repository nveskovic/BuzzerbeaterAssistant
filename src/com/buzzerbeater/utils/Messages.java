...
public class Messages {
	...
	public static String subjectTemplateDomestic = "NT Scout - igrac " + playerNamePlaceholder;
	public static String subjectTemplateEN = "NT Scout - player " + playerNamePlaceholder;
	...
	public static String greetingMessageTemplateDomestic = "Cao,\n\nja sam jedan od skauta U21 reprezentacije Srbije i od selektora sam dobio zadatak da sa tobom radim na "
			+ "treniranju igraca " + playerNamePlaceholder + ". Da bismo zajedno sto bolje napravili plan trening za igraca, potrebno mi je "
	...
	public	static String greetingMessageTemplateEN = "Hello,\n\nI'm one of the Serbia U21 NT scouts and from Serbia U21 national manager I was assigneg to monitor improvement of your player "
			+ playerNamePlaceholder + " beacuse he is interesting to Serbia U21 team. In order to help you train this player in the best way, I would be needing few info "
	...
	public static HashMap<String, String> getCustomMap() {
		HashMap<String, String> map = getBaseMap();
		map.put(MESSAGE_DOMESTIC_KEY, "Type your localized message here. Use " + playerNamePlaceholder + " to insert player name in the realtime in subject or message field");
		map.put(MESSAGE_ENGLISH_KEY, "Type your message in English here. Use " + playerNamePlaceholder + " to insert player name in the realtime in subject or message field");
